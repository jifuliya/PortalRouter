...
import static jifuliya.lyl.annotationprocess.Constant.PORTAL_ADAPTER;
...
public class PortalProcessor extends AbstractProcessor {
    ...
    private MethodSpec.Builder generateInitializeMethod() {
        ...
        ClassName portalRouterCls = ClassName.get("com.example.portalroutor", "PortalRoutor");
        ClassName portalActionCls = ClassName.get(BASE_URL, PORTAL_ACTION);
    ...
    private void generate(MethodSpec.Builder method1, MethodSpec.Builder method2) {
        ...
        TypeSpec bind_activity = TypeSpec.classBuilder(PORTAL_ADAPTER)
